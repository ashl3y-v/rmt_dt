...
class Compressor(nn.Module):
    def __init__(self, storage, block_size=11, max_length=200, dtype=T.float32, device="cpu"):
        super().__init__()
        ...
        self.compressor = nn.Conv1d(self.block_size, 1, kernel_size=self.block_size, padding=(self.block_size // 2))
        self.decompressor = nn.ConvTranspose1d(1, self.block_size, kernel_size=self.block_size, padding=(self.block_size // 2))
